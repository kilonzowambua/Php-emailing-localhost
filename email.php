...
if(!$mail->send()) {
  ...
  <div class="alert alert-background mb-4" role="alert">
    ...
    <strong>Sent!</strong> Email is successively Sent.
</div>
  ';
}
}
    ...
    <div class="main-container" id="container">
            ...
            <div class="layout-px-spacing">
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12  col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="d-flex mb-4 mail-to">
                                                                        ...
                                                                        <div class="">
                                                                            <input type="email" name="email" id="m-to" placeholder="To" class="form-control">
                                ...
                                <div class="">
                                    <textarea name="message" id="demo1">
                    ...
                    <div class="modal-footer">
                                                ...
                                                <button name="sent" id="btn-send" class="btn"> Send</button>
                                            </div>
                               </form>
                                                    </div>
                                                </div>
        ...
        <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2020 <a target="_blank" href="">Kilonzowambua</a>, All rights reserved.</p>
                </div>
